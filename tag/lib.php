...
/**
 * Set the type of a tag.  At this time (version 1.9) the possible values are 'default' or 'official'.  Official tags will be
 ...
 * @category tag
 * @access   public
 * @param    object   $tag_ object a line out of tag table, as returned by the adobd functions
 ...
 * @param   int/string    $limitfrom return a subset of records, starting at this point (optional, required if $limitnum is set).
 * @param   int/string    $limitnum  return a subset comprising this many records (optional, required if $limitfrom is set).
